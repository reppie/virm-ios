 ...
 *
 * IMPORTANT: the largest input dimension *MUST* be higher or equal than
 *            480 pixels. Too small images are rejected and a `MS_MISUSE`
 *            error code is returned.
 *
 * Whenever possible we recommend you to provide a 1280x720 pixels image
 * otherwise a 480x360 pixels one if your device camera can not produce it.
 */
